...
// affirm
router.get("/Alma/secret", async (req, res) => {
...
// affirm
router.post("/Alma/confirm", async (req, res) => {
...
// affirm
router.get("/Alma/affirm/secret2", async (req, res) => {
  try {
    const intent = await stripe.paymentIntents.create({
      amount: 6000,
      currency: "usd",
...
router.get("/Alma/secret3", async (req, res) => {
  try {
    const intent = await stripe.paymentIntents.create({
      currency: "usd",
...
router.get("/Alma/readers", async (req, res) => {
  try {
...
//新增客人
router.post("/Alma/customers", async (req, res) => {
  try {
...
//所有的顾客
router.get("/Alma/customers", async (req, res) => {
  try {
...
//删除
router.delete("/Alma/customers/:id", async (req, res) => {
  try {
...
router.get("/Alma/checkout", function (req, res, next) {
  res.render("AlmaCheckout", { title: "Express", $publicKey });
});
router.get("/Alma/checkout2", function (req, res, next) {
  res.render("AlmaCheckout2", { title: "Express", $publicKey });
});
router.get("/Alma/retrieve", async function (req, res, next) {
...
router.get("/Alma/payment_methods/:id", async function (req, res, next) {
  try {
